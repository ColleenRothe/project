...
class LandslideChoice: UIViewController, UIPickerViewDelegate, UIPickerViewDataSource, CLLocationManagerDelegate, UITextFieldDelegate, UIImagePickerControllerDelegate, UINavigationControllerDelegate, UIPopoverPresentationControllerDelegate, UITableViewDelegate, UITableViewDataSource, LandslideModelHelperProtocol, HazardTypeHelperProtocol {
    
    let shareData = ShareData.sharedInstance
    var feedItems: NSArray = NSArray()
    
    var hazardItems: NSArray = NSArray() //for the hazard type
