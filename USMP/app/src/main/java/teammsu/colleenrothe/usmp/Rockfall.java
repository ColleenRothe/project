...
public class Rockfall extends Object {
    ...
    public Rockfall(int id, int agency, int regional, int local, String date, String road_trail_number, int road_or_trail,
                    ...
                    String photos, String comments, String flma_name, String flma_id, String flma_description, int prelim_rockfall_ditch_eff,
                    ...
                    String hazard_rating_slope_height_axial_length, int hazard_rockfall_maint_frequency, int case_one_struc_cond,
                    int case_one_rock_friction, int case_two_struc_cond, int case_two_diff_erosion, String hazard_rating_total,
