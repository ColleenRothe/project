...
public class LandslideDBHandler extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase db) {
        ...
        String CREATE_LANDSLIDE_TABLE = "CREATE TABLE " +
                TABLE_LANDSLIDE + "("
                ...
                COLUMN_SECOND_BEGIN_DITCH_SLOPE+" TEXT,"+COLUMN_SECOND_END_DITCH_SLOPE+" TEXT,"+COLUMN_START_ANNUAL_RAINFALL+" TEXT,"+
                COLUMN_END_ANNUAL_RAINFALL+" TEXT,"+COLUMN_SOLE_ACCESS_ROUTE+" INTEGER,"+COLUMN_FIXES_PRESENT+ " INTEGER,"+COLUMN_PHOTOS
                +" TEXT,"+COLUMN_COMMENTS+" TEXT,"+COLUMN_FLMA_NAME+" TEXT,"+COLUMN_FLMA_ID+" TEXT,"+COLUMN_FLMA_DESCRIPTION+" TEXT,"+
                COLUMN_PRELIM_LANDSLIDE_ROAD_WIDTH_AFFECTED+" INTEGER,"+COLUMN_PRELIM_LANDSLIDE_SLIDE_EROSION_EFFECTS+" INTEGER,"+
                COLUMN_PRELIM_LANDSLIDE_LENGTH_AFFECTED+" TEXT,"+COLUMN_IMPACT_ON_USE+" INTEGER,"+COLUMN_AADT_USAGE_CALC_CHECKBOX+" INTEGER,"+
                ...
                +" INTEGER,"+COLUMN_HAZARD_LANDSLIDE_MAINT_FREQUENCY+" INTEGER,"+COLUMN_HAZARD_LANDSLIDE_MOVEMENT_HISTORY+" INTEGER,"+
                COLUMN_ROUTE_TRAIL_WIDTH+" TEXT,"+COLUMN_HUMAN_EX_FACTOR+" TEXT,"+COLUMN_PERCENT_DSD+" TEXT,"+COLUMN_R_W_IMPACTS+" INTEGER,"+
        ...
        db.execSQL(CREATE_LANDSLIDE_TABLE);
    ...
    public void onUpgrade(SQLiteDatabase db, int oldVersion, int newVersion) {
        // TODO Auto-generated method stub
        db.execSQL("DROP TABLE IF EXISTS " + TABLE_LANDSLIDE);
        onCreate(db);
    ...
    public void addLandslide(Landslide form){
        ...
        db.insert(TABLE_LANDSLIDE, null, values);
        db.close();
    }
    ...
    public Landslide findLandslide(int id){
        ...
        if (cursor.moveToFirst()) {
            cursor.moveToFirst();
            landslide.setId(Integer.parseInt(cursor.getString(0)));
            landslide.setAgency(Integer.parseInt(cursor.getString(1)));
            landslide.setRegional(Integer.parseInt(cursor.getString(2)));
            landslide.setLocal(Integer.parseInt(cursor.getString(3)));

            landslide.setDate(cursor.getString(4));
            landslide.setRoad_trail_number(cursor.getString(5));
            landslide.setRoad_or_Trail(Integer.parseInt(cursor.getString(6)));
            landslide.setRoad_trail_class(cursor.getString(7));
            landslide.setRater(cursor.getString(8));
            landslide.setBegin_mile_marker(cursor.getString(9));
            landslide.setEnd_mile_marker(cursor.getString(10));
            landslide.setSide(Integer.parseInt(cursor.getString(11)));
            landslide.setWeather(Integer.parseInt(cursor.getString(12)));
            landslide.setHazard_type(cursor.getString(13));
            landslide.setBegin_coordinate_lat(cursor.getString(14));
            landslide.setBegin_coordinate_long(cursor.getString(15));
            landslide.setEnd_coordinate_latitude(cursor.getString(16));
            landslide.setEnd_coordinate_longitude(cursor.getString(17));
            landslide.setDatum(cursor.getString(18));
            landslide.setAadt(cursor.getString(19));
            landslide.setLength_affected(cursor.getString(20));
            landslide.setSlope_height_axial_length(cursor.getString(21));
            ...
            landslide.setMaximum_ditch_depth(cursor.getString(29));
            landslide.setFirst_begin_ditch_slope(cursor.getString(30));
            landslide.setFirst_end_ditch_slope(cursor.getString(31));
            landslide.setSecond_begin_ditch_slope(cursor.getString(32));
            landslide.setSecond_end_ditch_slope(cursor.getString(33));
            landslide.setStart_annual_rainfall(cursor.getString(34));
            landslide.setEnd_annual_rainfall(cursor.getString(35));
            landslide.setSole_access_route(Integer.parseInt(cursor.getString(36)));
            landslide.setFixes_Present(Integer.parseInt(cursor.getString(37)));
            landslide.setPhotos(cursor.getString(38));
            landslide.setComments(cursor.getString(39));
            landslide.setFlma_name(cursor.getString(40));
            landslide.setFlma_id(cursor.getString(41));
            ...
            //Risk Ratings
            landslide.setRoute_trail_width(cursor.getString(57));
            landslide.setHuman_ex_factor(cursor.getString(58));
            landslide.setPercent_dsd(cursor.getString(59));
            landslide.setR_w_impacts(Integer.parseInt(cursor.getString(60)));
            landslide.setEnviro_cult_impacts(Integer.parseInt(cursor.getString(61)));
            landslide.setMaint_complexity(Integer.parseInt(cursor.getString(62)));
            landslide.setEvent_cost(Integer.parseInt(cursor.getString(63)));
            landslide.setRisk_total(cursor.getString(64));

            landslide.setTotal_score(cursor.getString(65));
